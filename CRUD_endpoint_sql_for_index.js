...
['中文 (中国語)', 'zh', ['请输入4000个字符以内','用户不存在','没有写权限','f_c添加失败','用户不存在','没有删除权限',], '🇨🇳🇹🇼'],
['スペイン語', 'es', ['Introduzca menos de 4000 caracteres','El usuario no existe','No tiene permiso de escritura','f_c no se pudo agregar','El usuario no existe','No tiene permiso de eliminación',], '🇪🇸'],
['英語', 'en', ['Please enter less than 4000 characters','The user does not exist','No write permission','f_c could not be added','The user does not exist','No delete permission',], '🇬🇧🇺🇸'],
['ヒンディー語', 'hi-IN', ['4000 अक्षरों से कम दर्ज करें','उपयोगकर्ता मौजूद नहीं है','लिखने की अनुमति नहीं है','f_c नहीं जोड़ा जा सका','उपयोगकर्ता मौजूद नहीं है','हटाने की अनुमति नहीं है',], '🇮🇳'],
['アラビア語', 'ar', ['الرجاء إدخال أقل من 4000 حرفًا','المستخدم غير موجود','لا يوجد إذن للكتابة','لم يتم إضافة f_c','المستخدم غير موجود','لا يوجد إذن للحذف',], '🇸🇦'],
['ポルトガル語', 'pt', ['Por favor, insira menos de 4000 caracteres','O usuário não existe','Sem permissão de escrita','f_c não pôde ser adicionado','O usuário não existe','Sem permissão de exclusão',], '🇵🇹'],
['ベンガル語', 'bn', ['4000 অক্ষরের কম প্রবেশ করুন','ব্যবহারকারী নেই','লেখার অনুমতি নেই','f_c যোগ করা যায়নি','ব্যবহারকারী নেই','মুছে ফেলার অনুমতি নেই',], '🇧🇩'],
['ロシア語', 'ru', ['Пожалуйста, введите менее 4000 символов','Пользователь не существует','Нет разрешения на запись','f_c не удалось добавить','Пользователь не существует','Нет разрешения на удаление',], '🇷🇺'],
['日本語', 'ja', ['4000文字以内で入力してください','ユーザーが存在しません','書き込み権限がありません','f_cの追加に失敗しました','ユーザーが存在しません','削除権限がありません',], '🇯🇵'],
['ドイツ語', 'de', ['Bitte geben Sie weniger als 4000 Zeichen ein','Der Benutzer existiert nicht','Keine Schreibberechtigung','f_c konnte nicht hinzugefügt werden','Der Benutzer existiert nicht','Keine Löschberechtigung',], '🇩🇪'],
['フランス語', 'fr', ['Veuillez entrer moins de 4000 caractères','L\'utilisateur n\'existe pas','Pas d\'autorisation d\'écriture','f_c n\'a pas pu être ajouté','L\'utilisateur n\'existe pas','Pas d\'autorisation de suppression',], '🇫🇷'],
['韓国語', 'ko', ['4000자 미만으로 입력하십시오','사용자가 존재하지 않습니다','쓰기 권한이 없습니다','f_c를 추가하지 못했습니다','사용자가 존재하지 않습니다','삭제 권한이 없습니다',], '🇰🇷'],
['タミル語', 'ta', ['4000 எழுத்துக்களில் குறைவாக உள்ளிடவும்','பயனர் இல்லை','எழுத்துக்களை எழுத அனுமதி இல்லை','f_c சேர்க்க முடியவில்லை','பயனர் இல்லை','நீக்க அனுமதி இல்லை',], '🇹🇲'],
['トルコ語', 'tr', ['Lütfen 4000 karakterden az girin','Kullanıcı mevcut değil','Yazma izni yok','f_c eklenemedi','Kullanıcı mevcut değil','Silme izni yok',], '🇹🇷'],
['イタリア語', 'it', ['Si prega di inserire meno di 4000 caratteri','L\'utente non esiste','Nessun permesso di scrittura','f_c non è stato aggiunto','L\'utente non esiste','Nessun permesso di eliminazione',], '🇮🇹'],
['ウクライナ語', 'uk', ['Будь ласка, введіть менше 4000 символів','Користувач не існує','Немає дозволу на запис','f_c не вдалося додати','Користувач не існує','Немає дозволу на видалення',], '🇺🇦'],
['グジャラト語', 'gu', ['4000 અક્ષરોમાં ઓછી પ્રબેશ કરો','વપરાશકર્તા અસ્તિત્વમાં નથી','લખાણ પર પરવાનગી નથી','f_c ઉમેરી શકાયું નથી','વપરાશકર્તા અસ્તિત્વમાં નથી','કાઢી નાખવા પર પરવાનગી નથી',], '🇮🇳'],
['ペルシア語 (イラン語)', 'fa', ['لطفاً کمتر از 4000 کاراکتر وارد کنید','کاربر وجود ندارد','مجوز نوشتن وجود ندارد','f_c اضافه نشد','کاربر وجود ندارد','مجوز حذف وجود ندارد',], '🇮🇷'],
['ポーランド語', 'pl', ['Wprowadź mniej niż 4000 znaków','Użytkownik nie istnieje','Brak uprawnień do zapisu','f_c nie został dodany','Użytkownik nie istnieje','Brak uprawnień do usuwania',], '🇵🇱'],
['シンド語', 'sd-IN', ['4000 ڪردينڊ ڪم ڏينهن ڏسو','يوزر موجود نه ۾','لکڻيون ڪي مجوز نه ۾','f_c ڪي اضافو نه ۾','يوزر موجود نه ۾','ڊيليٽ ڪي مجوز نه ۾',], '🇮🇳'],
]
